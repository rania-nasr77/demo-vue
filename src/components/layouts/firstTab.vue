<template>
  <div
    class="tab-pane fade"
    :class="{ 'show active': checkHomeRoute }"
    id="home"
    role="tabpanel"
                      ...
                      <div class="timeline timeline-5 mt-3">
                        ...
                        <div class="timeline-item align-items-start">
                          ...
                          <div class="timeline-badge">
                            <i
                              class="fa fa-genderless text-warning icon-xl"
                            ></i>
                          </div>
                          <!--end::Badge-->
                          <!--begin::Text-->
                        ...
                        <div class="timeline-item align-items-start">
                          ...
                          <div class="timeline-badge">
                            <i
                              class="fa fa-genderless text-success icon-xl"
                            ></i>
                          </div>
                          <!--end::Badge-->
                          <!--begin::Content-->
                        ...
                        <div class="timeline-item align-items-start">
                          ...
                          <div class="timeline-badge">
                            <i
                              class="fa fa-genderless text-primary icon-xl"
                            ></i>
                          </div>
                          <!--end::Badge-->
                          <!--begin::Text-->
