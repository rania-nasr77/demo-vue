      ...
      >
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <show-action
              :id="props.row.id"
              showUrlName="show-carClassifications"
            ></show-action>
            <edit-action
              :id="props.row.id"
...
export default {
  ...
  computed: {
    carClassifications() {
      return this.$store.getters.getCarClassifications;
    },
    visibleFields() {
  ...
  methods: {
    ...
    async getCarClassifications() {
      ...
      this.rows = this.$store.getters.getCarClassifications.data;
    },
    /**
     * delete item
     */
    async Delete(id) {
      ...
      if (result.value) {
        await this.$store.dispatch("deleteCarClassification", id);
