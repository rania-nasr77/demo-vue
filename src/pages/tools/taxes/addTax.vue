  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="newTax" id="currentForm">
...
import countires from "./countries.vue";
...
export default {
  ...
  methods: {
    async newTax() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("storeExample", {
            data: this.formData,
          });
        } catch (errors) {
    ...
    async getCode() {
      const code = await this.$store.dispatch("getExampleCode");
