  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="newtrailerWheels" id="trailerWheel">
...
export default {
  ...
  methods: {
    async newtrailerWheels() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("storetrailerWheels", {
            data: this.formData,
          });
        } catch (errors) {
    ...
    async getCode() {
      await $axios
        .get("wheel-types/code?vtype=2")
        .then((response) => {
          this.formData.code = response.data.data;
        })
        .catch((error) => {});
    },
  },
