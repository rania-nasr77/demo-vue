  ...
  <div>
    ...
    <div class="card card-custom mb-9 mt-10">
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="updateUnit" id="unit">
...
export default {
    ...
    methods: {
        async updateUnit() {
            console.log("Hit update unit method")
            this.$v.$touch();
            if (this.$v.$invalid) {
                console.log(this.$v);
                ...
                await this.$store.dispatch("updateUnit", params);
                } catch (errors) {
        ...
        async getUnit() {
            const getUnit = await this.$store.dispatch("getUnit", {
                Id: this.$route.params.id,
            });
            this.formData = getUnit.data.data;
        },
