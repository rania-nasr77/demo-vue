<template>
  <div>
    <top-bar-card
      :newUrlName="`edit-delegateCommissions`"
      :submit="updatedelegateCommissions"
    />
    <div class="card card-custom mb-9 mt-10">
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit="updatedelegateCommissions" id="currentForm">
          <div class="inf0-top-fixed">
            ...
            <div class="row align-items-end">
              ...
              <div class="col-6">
                <div class="has-float-label" v-if="selected == 'fixed_amount'">
                  <div class="form-group">
                    <input
                      type="number"
                      class="form-control"
              ...
              <div class="col-md-12" v-if="commissions.length > 0">
                <commissions
                  @deletedCommissionIds="deleteCommissions($event)"
  ...
  methods: {
    async updatedelegateCommissions() {
      try {
        ...
        formData.append("ids", this.deletedCommissionIds);
    ...
    deleteCommissions(commission_Id) {
      this.deletedCommissionIds.push(commission_Id);
    },
