<template>
  <div>
    <top-bar-card
      :newUrlName="`edit-paymentWays`"
      :submit="updatePaymentWays"
    />
    <div class="card card-custom mb-9 mt-10">
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="updatePaymentWays" id="currentForm">
              ...
              <div class="col-6">
                <lang-tabs :languages="languages">
                  <template v-slot:input="{ language }">
                    <editInputs :language="language" :PaymentWay="PaymentWay" />
                  </template>
                </lang-tabs>
              </div>
