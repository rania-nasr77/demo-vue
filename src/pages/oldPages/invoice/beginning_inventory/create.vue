<template>
  <div>
    <top-bar-card
      ...
      :newUrlName="`beginning.inventory.create`"
      :submit="newInvoice"
    />
            ...
            <table class="datatable-table table table-bordered">
              <thead class="datatable-head">
                <tr class="datatable-row" style="left: 0px">
                  ...
                  <th class="datatable-cell">
                    <span style="">Addition {{ $t("addition") }}</span>
                  </th>
                  <th class="datatable-cell">
                    <span style=""> {{ $t("addition") }} %</span>
                  </th>
                  ...
                  <div class="col-md-20">
                    ...
                    <div class="has-float-label">
                      <div class="form-group">
                        ...
                        />
                        <label>{{ $t("total_before_tax") }}</label>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-20">
                    ...
                    <div class="has-float-label">
                      <div class="form-group">
                        <input
                          class="form-control"
                          type="text"
                          :placeholder="`${$t('Actual_quantities')}`"
                        />
...
export default {
  name: "beginning.inventory.create.create",
  components: {
    LangTabs,
    Inputs,
    CustomerTab,
  ...
  methods: {
    ...
    initDateHijri(value = null) {
      ...
      } else this.hijri_date = `${hijriYear}/${hijriMonth}/${hijriDay}`;
    },
    hijri(e) {
