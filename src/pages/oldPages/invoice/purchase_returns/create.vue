                  ...
                  <div id="collapseOne" class="panel-collapse collapse in show">
                    <div class="panel-body">
                      <div class="row">
                        ...
                        <div class="col-4">
                          <div class="form-group has-float-label">
                            <label for="exampleTextarea"> {{ $t("reference") }}</label>
                            <select
                              class="form-control"
                        ...
                        <div class="col-4">
                          <div class="form-group has-float-label">
                            <label for="exampleTextarea">   {{ $t("reference_NO") }}</label>
                            <select
                              class="form-control"
                            ...
                            >
                              <option selected disabled>   {{ $t("reference_NO") }}</option>
                              <option
                                class="form-control"
                                style="border-radius: 10px"
                        ...
                        <div class="col-4">
                          <div class="form-group has-float-label">
                            <label for="exampleTextarea"> {{ $t("employees") }}</label>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a
                        ...
                        href="#collapseFour"
                      >
                        <i class="flaticon2-tag"></i> <span>{{ $t("notes") }}</span>
                      </a>
                    </h4>
                  </div>
