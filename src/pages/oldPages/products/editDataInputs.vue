              ...
              <div class="form-group has-float-label">
                <select class="form-control" id="" name="guarantee_id">
                  ...
                  <option
                    ...
                    :selected="guarantee.id == product.guarantee_id"
                  >
                    {{ guarantee.name }}
                  </option>
                </select>
              ...
              <div class="form-group has-float-label">
                <select class="form-control" id="" name="currency_id">
                  ...
                  <option
                    ...
                    :selected="product.currency_id == currency.id"
                  >
                    {{ currency.name }}
                  </option>
                </select>
              ...
              <div class="form-group has-float-label">
                <select class="form-control" id="" name="product_type_id">
                  ...
                  <option
                    ...
                    :selected="productType.id == product.product_type_id"
                  >
                    {{ productType.name }}
                  </option>
                </select>
              ...
              <div class="form-group has-float-label">
                <select class="form-control" id="" name="cost_way_id">
                  ...
                  <option
                    ...
                    :selected="product.costway_id == costWay.id"
                  >
                    {{ costWay.name }}
                  </option>
                </select>
              ...
              <div class="form-group has-float-label">
                <select class="form-control" id="" name="discount_id">
                  ...
                  <option
                    ...
                    :selected="discount.id == product.discount_id"
                  >
                    {{ discount.name }}
                  </option>
                </select>
              ...
              <div class="form-grou has-float-label">
                <select class="form-control" name="producer_id">
                  ...
                  <option
                    ...
                    :selected="producer.id == product.producer_id"
                  >
                    {{ producer.name }}
                  </option>
                </select>
            ...
            <div class="col-3 has-float-label">
              <div class="form-group">
                <input
                  ...
                  aria-describedby="emailHelp"
                  :value="product.beginning_cost_price"
                />
                <label for="inputState" class="col-form-label">{{
          ...
          <div class="row">
            <div class="col-6">
              <h5 class="font-weight-bolder text-primary">
                {{ $t("Discount_or_Adding_for_Purshase") }}
              </h5>
              <div class="separator separator-solid my-3"></div>
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="purshase_type">
                      <option></option>
                      <option value="add" :selected="purshase_type == 'add'">
                        {{ $t("Add") }}
                      </option>
                      <option
                        value="minus"
                        :selected="purshase_type == 'minus'"
                      >
                        Minus
                      </option>
                    </select>
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    ...
                    >
                      ...
                      <option
                        value="fixed"
                        :selected="purshase_value_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="purshase_value_type == 'percentage'"
                      >
                        {{ $("Percentage") }}
                      </option>
                    </select>
                    ...
                    <span class="text-danger" v-if="errors.purshase_value_type">
                ...
                <div class="col-6 align-self-end">
                  <div class="form-group">
                    <input
                      ...
                      id=""
                      :value="product.purshase_effect"
                      :checked="product.purshase_effect == 1"
                      class="mr-2"
                    />
                    <label for="">{{ $("Purshase_effect") }}</label>
                  </div>
                </div>
                <div class="col-6 has-float-label">
                  <div class="form-group">
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    ...
                    >
                      ...
                      <option
                        value="fixed"
                        :selected="product.purshase_free_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="product.purshase_free_type == 'percentage'"
                      >
                        {{ $t("Percentage") }}
                      </option>
                    </select>
                    ...
                    <span class="text-danger" v-if="errors.purshase_free_type">
                ...
                <div class="col-6 has-float-label">
                  <div class="form-group">
                    <input
                      ...
                      :value="product.purshase_max_value"
                      aria-describedby="emailHelp"
                    />
                    <label for="inputState" class="col-form-label">{{
                      $t("purshase_max_value")
                    }}</label>
                    <span class="text-danger" v-if="errors.purshase_max_value">
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="purshase_max_type">
                      <option></option>
                      <option
                        value="fixed"
                        :selected="product.purshase_max_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="product.purshase_max_type == 'percentage'"
                      >
                        {{ $t("Percentage") }}
                      </option>
                    </select>
                    <label for="inputState" class="col-form-label"
                      >Purshase max type</label
                    >
            ...
            <div class="col-6">
              <h5 class="font-weight-bolder text-primary">
                {{ $t("Discount_or_Adding_for_Sales") }}
              </h5>
              <div class="separator separator-solid my-3"></div>
              <div class="row">
                <div class="col-6 has-float-label">
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="sales_type">
                      ...
                      <option
                        value="add"
                        :selected="product.sales_type == 'add'"
                      >
                        {{ $t("Add") }}
                      </option>
                      <option
                        value="minus"
                        :selected="product.sales_type == 'minus'"
                      >
                        {{ $t("Minus") }}
                      </option>
                    </select>
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="sales_value_type">
                      <option></option>
                      <option
                        value="fixed"
                        :selected="product.sales_value_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="product.sales_value_type == 'percentage'"
                      >
                        {{ $t("Percentage") }}
                      </option>
                    </select>
                ...
                <div class="col-6 align-self-end">
                  <div class="form-group">
                    <input
                      ...
                      id="sales_effect"
                      value="1"
                      :checked="product.sales_effect == 1"
                      class="mr-2"
                    />
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="sales_free_type">
                      ...
                      <option
                        value="fixed"
                        :selected="sales_free_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="sales_free_type == 'percentage'"
                      >
                        {{ $t("Percentage") }}
                      </option>
                    </select>
                ...
                <div class="col-6">
                  <div class="form-group has-float-label">
                    <select class="form-control" id="" name="sales_max_type">
                      ...
                      <option
                        value="fixed"
                        :selected="product.sales_max_type == 'fixed'"
                      >
                        {{ $t("Fixed") }}
                      </option>
                      <option
                        value="percentage"
                        :selected="product.sales_max_type == 'percentage'"
                      >
                        {{ $t("Percentage") }}
                      </option>
                    </select>
