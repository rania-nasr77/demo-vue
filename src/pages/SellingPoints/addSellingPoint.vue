  ...
  <div>
    ...
    >
      ...
      <div class="card-header flex-wrap border-0 pb-0 d-block">
        <form @submit.prevent="newSellingPoint" id="sellingPoint">
...
export default {
  ...
  methods: {
    async newSellingPoint() {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.$store.dispatch("storeSellingPoint", {
            data: this.formData,
          });
        } catch (errors) {
          console.log(errors)
    ...
    async getCode() {
      const code = await this.$store.dispatch("getSellingPointCode");
